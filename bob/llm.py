...
class OllamaChat:
    ...
    def generate(self, instruction: str, user_text: str, num_predict: int = 256) -> str:
        payload = {
            ...
            "stream": False,
            "keep_alive": -1,
            "options": {"num_ctx": min(self.num_ctx, 2048), "num_predict": num_predict, "temperature": 0.2},
        }
    ...
    def chat(
        ...
        for index in range(tool_rounds + 1):
            ...
            content, calls = yield from self._round(system, offered, cancel)
    ...
    def _fold_summary(self, overflow: list[dict[str, Any]]) -> None:
        ...
        for msg in overflow:
            lines.append(_transcript_line(msg))
